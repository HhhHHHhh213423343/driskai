...
export default function AnalysisPlatform({ companyId, initialCategory }: { companyId: string; initialCategory?: string }) {
  ...
  function changeCategory(next: Category) { setCategory(next); router.replace(`/analysis/${companyId}?tab=${next}`, { scroll: false }); }
